# P0 Asset Batch 72 - Nephthys Unity Reference Install

Date: 2026-06-15

## Task Scope

Install a Unity-side Nephthys source-reference atlas built only from
...
reference while the current Nephthys combat sprite remains unchanged.

This is not a new cat-body generation task. Do not use AI-generated
Nephthys body art, do not replace the existing combat sprite, and do
...
- Batch 70 Nephthys reference plates:
  ...
  - `design/development/asset_candidates/starter_cats/batch_70_source_turnaround_reference_plates_2026-06-15/thecat_cat_nephthys_turnaround_side_reference_plate_768_batch70_v001.png`
  - `design/development/asset_candidates/starter_cats/batch_70_source_turnaround_reference_plates_2026-06-15/thecat_cat_nephthys_turnaround_back_reference_plate_768_batch70_v001.png`
...
- Batch 72 manifest and review packet under:
...
- Do not overwrite `Assets/TheCat/Art/Characters/Sprites/thecat_cat_nephthys_combat_sprite_512_v001.png`.
- Do not overwrite the Nephthys HUD avatar `thecat_cat_nephthys_hud_avatar_256_v001`.
...
- The atlas is a direct left-to-right concatenation of the Batch 70 front,
  side, and back Nephthys reference plates.
- The manifest records the Nephthys colored-turnaround source hash,
...
- `P0AssetManifestCatalog` includes the atlas as a `reference_atlas` generated
  asset with `nephthys_turnaround_colored` source lock.
...
```powershell
& 'C:\Users\PC\.cache\codex-runtimes\codex-primary-runtime\dependencies\python\python.exe' design/development/tools/build_starter_cat_unity_reference_install_assets.py --cats nephthys
...
- Capture active-cat Nephthys Play Mode screenshot and compare
